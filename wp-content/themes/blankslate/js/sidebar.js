    ...
    $.fn.burgerMenu = function(options) {
        ...
        function showHideMenu($menu, hide, $button){
            ...
            if(settings.translate){
                ...
                $('#insur #sidebar ').animate(bodyAnimation, settings.animateSpeed);
            }
            ...
            if(settings.overlay !== false ){
                if(!hide){
                    ...
                    $('#insur #sidebar ').append($('<div>').attr('class', 'burger-menu-overlay').css({
                        opacity: 0,
        ...
        return this.each(function(eq){
            ...
            $('#insur #sidebar ').append($button, $menu);
            ...
            if(settings.hideOnBodyClick){
                ...
                $('#insur #sidebar ').on('click', function(event){
